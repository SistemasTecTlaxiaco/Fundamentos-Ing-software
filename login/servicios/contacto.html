...
<html>
	...
	<body>
		<div id="principal">
			<header>
				<div id="logo">
					<h2 class="titulo">"EGAL"</h2>
					<p class="sub-titulo">Prestadores De Servicio</p>
				</div>
			...
			<section id="categorias">
				<section id="formulario">
					...
					<div id="datos">
							Teléfono Fijo: <strong>952134567</strong><br>
							Teléfono Celular: <strong>9537560123</strong><br>
							E-Mail: <strong>Pserv_egal@gmail.com</strong><br>
							Dirección: <strong>Tlaxiaco Oaxaca</strong><br>
						</div>
				</section>
